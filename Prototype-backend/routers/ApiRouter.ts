...
export default class ApiRouter {
    ...
    getRouter() {
        ...
        console.log(eventRouter.getRouter);
        ...
        router.use("/event", this.jwtAuth.authenticate(), eventRouter.getRouter());
        // console.log("eventRouter type",typeof(eventRouter.getRouter()));
        return router;
